CKEDITOR.plugins.add('omdevcmd', {
        //implemented as exxample to localize ckeditor toolbar buttons (see also below prop label, [lang].js (e.g. 'en.js', expected in "omdevcmd/lang" folder))
        //lang: "de,en,fr",
            ...
            editor.ui.addButton('omdevcmd',
                {
                    ...
                    //label: editor.lang.omdevcmd.label,
